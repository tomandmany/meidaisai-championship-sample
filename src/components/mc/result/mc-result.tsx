// @/components/mc/result/mc-result.tsx

import MCResultByDepartment from "@/components/mc/result/mc-result-by-department";
...
export default function MCResult({ departments, allVotes }: MCResultProps) {
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto z-mc-history-modal bg-mc-background bg-white">
      {/* <div className="font-bold text-2xl text-white p-6 sm:text-center bg-[#EB9697] sticky top-0 z-mc-history-title">
        投票結果
      </div> */}
      <div className="font-bold pl-6 sm:pl-0 text-xl text-white h-[50px] flex items-center sm:justify-center bg-[#EB9697] sticky left-0 top-0 z-mc-history-title">
        投票結果
      </div>
      <div className="sm:min-h-[calc(100svh-50px)] mx-5 my-10 sm:my-0 flex flex-col sm:flex-row justify-center gap-2 sm:gap-10 sm:py-16">

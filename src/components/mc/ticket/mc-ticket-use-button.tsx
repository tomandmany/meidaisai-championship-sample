// app/components/mc/ticket/mc-ticket-use-button.tsx
...
interface MCTicketUseProps {
  userId: string;
  isTicketUsed: boolean;
  setIsTicketUsed: Dispatch<SetStateAction<boolean>>;
};

export default function MCTicketUseButton({ userId, isTicketUsed, setIsTicketUsed }: MCTicketUseProps) {

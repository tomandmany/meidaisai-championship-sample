// app/components/mc/form/mc-form-filter-section.tsx

import { Grid2x2, MapPin, Users } from "lucide-react"
import { Button } from "@/components/ui/button"

type MCFormFilterSectionProps = {
    label: string
    items: string[]
...
export default function MCFormFilterSection({ label, items, selectedItems, onChange, onReset }: MCFormFilterSectionProps) {
    let labelIcon;
